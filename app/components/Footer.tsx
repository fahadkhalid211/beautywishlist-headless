      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4">
        <div>
          ...
          <div className="mt-5 flex items-center gap-3">
            <a
              href="https://www.facebook.com/share/1Fu71NDCEv/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="grid h-9 w-9 place-items-center rounded-full border border-line text-ink-soft transition hover:border-purple-300 hover:text-purple-700"
            >
            ...
            <a
              href="https://www.instagram.com/beautywishliist_hinashahab"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://youtube.com/@beautywishlistbyhinashahab8966?si=qAwKg0RrgDIbb_R9"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="grid h-9 w-9 place-items-center rounded-full border border-line text-ink-soft transition hover:border-purple-300 hover:text-purple-700"
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-ink-soft">
            <li>
              <a href="mailto:beautywishlistbyhs@gmail.com" className="hover:text-purple-700">
                beautywishlistbyhs@gmail.com
              </a>
            </li>
            <li>
              <a href="tel:+923035562424" className="hover:text-purple-700">
                +92 303 5562424
              </a>
            </li>
          </ul>
          <p className="mt-4 text-sm text-ink-soft">
            Paid online? Send a screenshot on WhatsApp.
          </p>
        </div>
      </div>
